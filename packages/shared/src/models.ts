...
export const LIVE_MODEL_OPTIONS = [
  ...
  },
  {
    ...
    provider: 'opencode-go',
    description: 'Budget hosted option for lower-cost live demos after output quality is validated.',
    isReasoning: true,
  ...
  },
  {
    ...
    label: 'MiMo v2.5',
    provider: 'opencode-go',
    description: 'Budget fallback if DeepSeek output is unsuitable for the markdown renderer.',
    isReasoning: false,
    tags: ['budget', 'fast'],
    inputCostUsdPerMillion: 0.14,
    outputCostUsdPerMillion: 0.28,
