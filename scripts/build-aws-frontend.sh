...
VITE_AUTH_API_BASE_URL= VITE_API_BASE_URL= VITE_DEMO_XSCAN_API_BASE_URL=/api/xscan VITE_BASE_PATH=/demo-xscan/ pnpm --filter @workspace/demo-xscan build:pages
